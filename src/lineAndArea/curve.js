...
define(function (require) {
    ...
    function curve(b) {
        this._tension = b ? 0.5 : 0;

        this._curveMethod = splineMethod.cardinal;
     ...
     */
    function cardinalCurve(points, tension, numOfSeg, close) {

        'use strict';

        if( util.isObject(points[0]) ) {
